  ...
  return (
    <div className="h-24">
      <form className="h-full flex items-center px-4" onSubmit={onSubmitChat}>
        ...
        />
        <button
          className="w-28 py-[6px] text-sm bg-indigo-400 hover:bg-indigo-600 active:bg-indigo-400 rounded-lg text-white font-semibold flex justify-center"
          type="submit"
          disabled={isLoading}>
            {isLoading ? <CgSpinner className="animate-spin " size={22}/> : "검   색"}
